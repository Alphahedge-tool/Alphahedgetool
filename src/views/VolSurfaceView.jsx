  ...
  createEffect(() => {
    ...
    import("plotly.js-dist-min").then((Plotly) => {
      ...
      const trace = {
        ...
        colorbar: {
          title: { text: "IV %", font: { color: "#8c8ca0", size: 10 } },
          tickfont: { color: "#8c8ca0", size: 10 },
          thickness: 12,
          len: 0.7,
        },
      ...
      const layout = {
        ...
        scene: {
          bgcolor: "#0d1117",
          xaxis: {
            title: { text: "Strike", font: { color: "#8c8ca0", size: 10 } },
            tickfont: { color: "#8c8ca0", size: 9 },
            gridcolor: "rgba(255,255,255,0.08)",
            zerolinecolor: "rgba(255,255,255,0.12)",
            backgroundcolor: "#0d1117",
          },
          yaxis: {
            title: { text: "Expiry", font: { color: "#8c8ca0", size: 10 } },
            tickfont: { color: "#8c8ca0", size: 9 },
            tickvals: yVals,
            ticktext: yLabels,
            gridcolor: "rgba(255,255,255,0.08)",
        ...
        font: { color: "#b4b4c8", family: "system-ui,sans-serif" },
      };
